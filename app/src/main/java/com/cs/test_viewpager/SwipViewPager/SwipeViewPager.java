...
import com.cs.test_viewpager.uitls.DensityUtil;
...
public class SwipeViewPager extends RelativeLayout implements AutoInterface {
    ...
    private void onInitView() {
        final View view = View.inflate(getContext(), R.layout.auto_viewpager_layout, this);
    ...
    private void addIndicatorImageViews(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i != 0) {
                lp.leftMargin = DensityUtil.dip2px(getContext(), 7);//设置导航点之间的距离
            }
